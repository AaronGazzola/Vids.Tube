...
begin
  ...
  -- History can disappear: a broadcast is deleted, or a message is removed.
  -- Returning early here left the membership frozen with totals that no longer
  -- had anything behind them, and nothing ever corrected it. Zero the derived
  -- columns instead, keeping credits and rewards, which are not derived.
