# tts-requests Specification

## Purpose

Let viewers have moderated messages spoken on stream: !tts requests pass an AI
verdict, flow suggest/auto like bans, synthesize via ElevenLabs into the public
tts bucket, and play serially through the highlight overlay browser source so
OBS mixes the audio without touching the encoder setup.
