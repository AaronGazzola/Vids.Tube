...
- [ ] 4.3 (owner-run) Open `/studio/control`; with a seeded stream (`npm run smoke:bot -- --keep`) or live, confirm chat + read-this populate and the moderation slots render disabled
