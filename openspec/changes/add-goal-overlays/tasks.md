...
- [ ] 6.3 (deferred — needs the owner's live YouTube broadcast + OBS; tracked as **AZ-128**) Confirm `/overlay/<channelSlug>/goals` renders real likes/subs/viewers and the rainbow on reach; demo mode previews layout
- [ ] 6.4 (after live confirm) Retire the standalone `Stream Overlays` repo (coordinate with AZ-122)
