...
function buildForm(s: StreamSettings): SettingsForm {
  return {
    ...
    competitionStatusEnabled: s.competitionStatusEnabled,
    progressUpdateEnabled: s.progressUpdateEnabled,
    wrapupMvpEnabled: s.wrapupMvpEnabled,
    wrapupSummaryEnabled: s.wrapupSummaryEnabled,
    wrapupThanksEnabled: s.wrapupThanksEnabled,
    bridgeEnabled: s.bridgeEnabled,
    greetReturning: s.greetReturning,
...
export default function LivePage() {
  ...
  const buildPayload = (f: SettingsForm) => ({
    ...
    competitionStatusEnabled: f.competitionStatusEnabled,
    progressUpdateEnabled: f.progressUpdateEnabled,
    wrapupMvpEnabled: f.wrapupMvpEnabled,
    wrapupSummaryEnabled: f.wrapupSummaryEnabled,
    wrapupThanksEnabled: f.wrapupThanksEnabled,
    bridgeEnabled: f.bridgeEnabled,
    greetReturning: f.greetReturning,
